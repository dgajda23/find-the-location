...
fun ClueScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = stringResource(id = clue.clueTextID),
            ...
            if (showHint) {
                ...
                Text(
                    text = stringResource(id = R.string.hint_semi_col) + " " + stringResource(id = clue.hintTextID),
                    style = TextStyle(fontSize = 25.sp)
                )
            }
        }
        Box(
            ...
            Button(
                ...
                Text(
                    text = stringResource(id = R.string.found_it),
